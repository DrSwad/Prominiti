...
class AlertReceiver: BroadcastReceiver() {
    override fun onReceive(p0: Context?, p1: Intent?) {
        ...
        val i = Intent(p0, DestinationActivity::class.java)
        ...
        val builder = NotificationCompat.Builder(p0!!, "prominiti_channel").setSmallIcon(R.drawable.ic_launcher_background)
            .setContentTitle("Prominity Alert").setContentText("Alarm")
            .setAutoCancel(true)
